...
api_urlpatterns = [
    path("authors/search/<str:query>", library_api_views.BookAuthorSearchAPIView.as_view(), name="author-search"),
    path("book-categories/search/<str:query>", library_api_views.BookCategorySearchAPIView.as_view(),
